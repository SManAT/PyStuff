...
class MAIN_UI(PyQt5.QtWidgets.QMainWindow):
    startNotification_Signal = pyqtSignal()
    endNotification_Signal = pyqtSignal()
    ...
    def __init__(self,parent=None):
        ...
        self.startNotification_Signal.connect(self.notification.show)
        self.endNotification_Signal.connect(self.notification.hide)

        self.ui.btn1.clicked.connect(lambda: self.startNotification())
        self.ui.btn1.clicked.connect(lambda: self.endNotification())
